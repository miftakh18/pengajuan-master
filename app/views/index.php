...
<script>
    let btn = `   <button id="btn-confirm" data-id="<?= $param; ?>" class="block w-full border bg-green-500 hover:bg-green-700 rounded-full text-white text-sm px-10 py-2 mx-2 border shadow-sm/50 active:shadow-sm/20 hover:font-light  font-bold font-nunito tracking-[0.2rem] ">KONFIRMASI</button>`;
     let btn2 = `   <button id="btn-view" data-id="<?= $param; ?>" class="block w-full bg-sky-500 hover:bg-sky-700 rounded-full text-white text-sm px-10 py-2 shadow-sm/50 active:shadow-sm/20 hover:font-light  font-bold font-nunito tracking-[0.2rem] ">VIEW</button>`;
    let textPengajuan = `
    ...
    $(document).on("click", "#btn-confirm", function() {
        let id = $(this).data('id');
            ...
            customClass: {
                ...
                confirmButton:
                ' font-nunito! bg-sky-500 hover:bg-sky-700 text-white px-10 py-2 rounded-full tracking-wider  ',
